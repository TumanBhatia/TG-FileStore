...
class Config(object):
	API_ID = int(os.environ.get("27473163", "0"))
	API_HASH = os.environ.get("f199e74434dfa81f6ec26c8b7ed4655a")
	BOT_TOKEN = os.environ.get("7121414283:AAEiCnUwpMpQAucMMREe8_z9ldes-KHFEYs")
	BOT_USERNAME = os.environ.get("@tumanfilessbot")
	DB_CHANNEL = int(os.environ.get("-1002045321304", "-100"))
	BOT_OWNER = int(os.environ.get("944416662", "1445283714"))
	DATABASE_URL = os.environ.get("mongodb+srv://Tuman:Mahipal@cluster0.cmhekdn.mongodb.net/?retryWrites=true&w=majority


")
	UPDATES_CHANNEL = os.environ.get("-1001826865286", "")
	LOG_CHANNEL = os.environ.get("-1002099376335", None)
